...
public class RayTracingRenderPipeline : RenderPipeline
{
    ...
    /// </summary>
    private readonly RayTracingRenderPipelineAsset _asset;

    /// <summary>
    ///     all prng states for camera.
    /// </summary>
    private readonly Dictionary<int, ComputeBuffer> _PRNGStates = new();
    ...
    public ComputeBuffer RequirePRNGStates(Camera camera)
    {
        ...
        var _mt19937 = new mt19937ar_cok_opt_t();
        _mt19937.init_genrand((uint) DateTime.Now.Ticks);
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        foreach (var pair in _PRNGStates) pair.Value.Release();
