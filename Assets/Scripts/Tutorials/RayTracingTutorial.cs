...
public abstract class RayTracingTutorial
{
    ...
    ///     the tutorial asset.
    /// </summary>
    private readonly RayTracingTutorialAsset _asset;

    /// <summary>
    ///     the output target.
    /// </summary>
    private readonly Dictionary<int, RTHandle> _outputTargets = new();
    ...
    /// </summary>
    private readonly Dictionary<int, Vector4> _outputTargetSizes = new();
    ...
    {
        foreach (var pair in _outputTargets) RTHandles.Release(pair.Value);
